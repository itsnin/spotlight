// spotlight - clipboard indicator (adapted from clipboard-indicator@tudmotu.com v71)
// SPDX-License-Identifier: GPL-3.0-or-later
// Core logic extracted verbatim from upstream. Only constructor adapted to
// receive dependencies directly instead of via this.extension.
...
// Constructor params: { clipboard, settings, openSettings, uuid }
const ClipboardIndicator = GObject.registerClass({
    GTypeName: 'SpotlightClipboardIndicator'
    ...
    _scheduleNextHistoryClear() {
        ...
        this._settings.set_int(PrefsFields.NEXT_HISTORY_CLEAR, NEXT_HISTORY_CLEAR);
    ...
    _resetHistoryClearTimer() {
        ...
        this._timerIntervalId = null;
        this._updateIntervalTimer();
        this._settings.set_int(PrefsFields.NEXT_HISTORY_CLEAR, -1);
    }
    ...
    async #getClipboardContent () {
        ...
        for (let type of mimetypes) {
            let result = await new Promise(resolve => this._clipboard.get_content(CLIPBOARD_TYPE, type, (clipBoard, bytes) => {
