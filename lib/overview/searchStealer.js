...
export class OverviewSearchStealer {
    ...
    steal() {
        ...
        // The container rules only match once St restyles the entry against its
        // new parent, which lands a frame after the popup is shown. Setting the
        // background inline keeps the Overview grey from painting at all.
