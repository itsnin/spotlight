...
3. **system actions** — type lock suspend restart shutdown or logout to control your system
...
the codebase is 22 modular javascript files all at the root level following the same flat structure used by mature extensions like dash-to-dock
