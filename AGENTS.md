...
`shellVersion.js` exports `SHELL_VERSION` and convenience booleans like `IS_GNOME_48` for any future feature detection needs currently no code uses them but they exist so version-specific workarounds have a single home
...
spotlight@nin/
    ...
    shellVersion.js           gnome version detection
