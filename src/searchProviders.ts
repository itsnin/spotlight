...
const SETTINGS_PANELS: {id: string; title: string}[] = [
    {id: 'wifi', title: 'Wi-Fi'},
...
const SYSTEM_ACTIONS: {id: string; title: string; icon: string; keywords: string[]; activate: () => void}[] = [
    {
        id: 'lock',
        title: 'Lock Screen',
...
export function searchApps(query: string, maxResults: number): SearchResult[] {
    const appSystem = Shell.AppSystem.get_default();
    const allApps = appSystem.get_installed();
    const seenNames = new Set<string>();
    const scored: {app: any; appId: string; title: string; score: number}[] = [];
...
export function searchCalculator(query: string): SearchResult | null {
...
export function searchSystemActions(query: string): SearchResult[] {
...
export function searchWeb(query: string, engineName: string): SearchResult {
